...
class PrintCommands {
  ...
  /// Appends text to the commands
  append(String text) {
    this._commands.add({"append": text});
  }

  /// Sets text alignment
  appendAlignment(StarAlignmentPosition position) {
    this._commands.add({"appendAlignment": position.text});
  }

  /// Sets text emphasis (bold)
  appendEmphasis(bool emphasis) {
    this._commands.add({"appendEmphasis": emphasis});
  }

  /// Appends scaled text
  appendMultiple(String text, int width, int height) {
    this._commands.add({
      "appendMultiple": text,
      "width": width,
      "height": height,
